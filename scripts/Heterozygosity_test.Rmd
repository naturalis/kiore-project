...
mctest::mctest(testLM3, type = "b") # tests for collinearity, most tests did not detect e.g. condition number = 7.6872 (issue if >30) and VIF = 1.727 (issue if >5)
```

...
* Diagnostic Plots: indications that the relationship is linear, normal distribution of residuals, down trending scale-location plot and cone-shaped residuals vs. fitted plot therefore non-constant variance, and 132 and 148 are potential issues.
...
par(mfrow = c(1, 1))
residualPlots(LM) # Tukey test p-value 0.06849 therefore H0 linearity not rejected
...
* Only approx. 16% of the variance of fst.dist can de explained by geo.dist!

...
# after some experimenting, spaces in the base strings aren't necessary, but 10 character length names ar needed, dashes "-" are allowed, no differentiation between upper and lower case, any letters allowed (not just ATCG and other IUPAC code)
```
Adapted IUPAC code:  
